...
def acquire_and_display_images(cam, nodemap, nodemap_tldevice):
    ...
    try:
        ...
        cv2.namedWindow('NIR Image Acquisition', cv2.WINDOW_NORMAL)
        cv2.resizeWindow('NIR Image Acquisition', 800, 600)
        ...
        while(continue_recording):
            ...
            try:
                ...
                if image_result.IsIncomplete():
                    ...
                    image_data = image_result.GetNDArray()  
                    image_data = cv2.cvtColor(image_data, cv2.COLOR_GRAY2RGB)  # Conversão para BGR (se necessário)

                    cv2.imshow('NIR Image Acquisition', image_data)  # Exibe o frame no OpenCV
